...
pub const NativeCameraPreview = struct {
    ...
    recording_window: ?*c.ANativeWindow = null,
    recording_egl_surface: c.EGLSurface = c.EGL_NO_SURFACE,
    outputs: ?*c.ACaptureSessionOutputContainer = null,
    output: ?*c.ACaptureSessionOutput = null,
    recording_output: ?*c.ACaptureSessionOutput = null,
    target: ?*c.ACameraOutputTarget = null,
    recording_target: ?*c.ACameraOutputTarget = null,
    ...
    recording_writer_handle: c.jlong = 0,
    recording_config: ManagedSegmentConfig = .{},
    recording_final_path: [1024:0]u8 = [_:0]u8{0} ** 1024,
    recording_segment_start_ms: i64 = 0,
    recording_next_segment_ms: i64 = 0,
    recording_segment_index: i32 = 0,
    recording_drained_samples: i64 = 0,
    recording_frame_index: i64 = 0,
    recording_last_presentation_time_ns: i64 = -1,
};
