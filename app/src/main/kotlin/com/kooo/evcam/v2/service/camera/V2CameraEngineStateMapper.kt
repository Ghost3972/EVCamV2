...
internal object V2CameraEngineStateMapper {
    ...
    fun healthSnapshot(
        ...
        released: Boolean,
        recording: Boolean,
        compositePreviewAttached: Boolean,
        nativeCompositePreviewRenders: Long,
        ...
        nativeCompositePreviewRenders = nativeCompositePreviewRenders,
    ...
    private fun V2CameraSlotState.toHealth(): V2CameraSlotHealth = V2CameraSlotHealth(
        ...
        sessionOpen = sessionOpen,
        inputReady = inputReady,
        singlePreviewAttached = previewAttached,
        frameSignals = frameSignals,
        renderFailures = renderFailures,
        lastRenderMs = lastRenderMs,
