...
class V2StatusBarPlugin : Service(), StatusBarPlugin, View.OnClickListener {
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.btn_status_bar_open -> openMainActivity()
        }
    }
    ...
    private fun statusLabel(serviceReady: Boolean, recording: Boolean): String =
        if (!serviceReady) "未录制" else if (recording) "循环录制中" else "未录制"
